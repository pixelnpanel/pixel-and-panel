...
const FOOTER_COPY = {
  en: {
    ...
    description: 'Professional websites, signs, and print materials that help Southeast Texas businesses get noticed and get more customers.',
  ...
  es: {
    ...
    description: 'Sitios web profesionales, letreros y materiales impresos que ayudan a negocios del sureste de Texas a verse mejor y recibir más clientes.',
