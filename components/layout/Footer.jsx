        ...
        <div style={{
          ...
          <div>
            <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none', marginBottom: '1.25rem' }}>
              <Image src="/logo/icon-512px.png" alt="Pixel & Panel" width={40} height={40} style={{ borderRadius: '0px' }} />
              <span style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 900, fontSize: '1rem', color: 'white' }}>
                PIXEL <span style={{ color: '#F59E0B' }}>&amp;</span> PANEL
              </span>
            </Link>

            <p style={{ color: '#94a3b8', fontSize: '0.875rem', lineHeight: 1.7, marginBottom: '1.5rem', fontFamily: 'Inter, sans-serif' }}>
          ...
          {/* Digital Services */}
          <div>
            <h4 style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#0EA5E9', marginBottom: '1.25rem' }}>
              Digital Services
            </h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {DIGITAL_SERVICES.map((item) => (
                <li key={item.href}>
                  <Link href={item.href} style={{ color: '#94a3b8', fontSize: '0.875rem', textDecoration: 'none', fontFamily: 'Inter, sans-serif' }}>
                    {item.name}
                  </Link>
                </li>
              ))}
            </ul>
            <Link href="/digital" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', marginTop: '1.25rem', fontSize: '0.75rem', fontWeight: 700, color: '#0EA5E9', textDecoration: 'none', fontFamily: 'Montserrat, sans-serif', textTransform: 'uppercase' }}>
          ...
          {/* Signage Products */}
          <div>
            <h4 style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#F59E0B', marginBottom: '1.25rem' }}>
              Signage Products
            </h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {SIGNAGE_PRODUCTS.slice(0, 9).map((item) => (
                <li key={item.href}>
                  <Link href={item.href} style={{ color: '#94a3b8', fontSize: '0.875rem', textDecoration: 'none', fontFamily: 'Inter, sans-serif' }}>
                    {item.name}
                  </Link>
            ...
            <Link href="/signage" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem', marginTop: '1.25rem', fontSize: '0.75rem', fontWeight: 700, color: '#F59E0B', textDecoration: 'none', fontFamily: 'Montserrat, sans-serif', textTransform: 'uppercase' }}>
          ...
          {/* Company */}
          <div>
            <h4 style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#64748b', marginBottom: '1.25rem' }}>
              Company
            </h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '2rem' }}>
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} style={{ color: '#94a3b8', fontSize: '0.875rem', textDecoration: 'none', fontFamily: 'Inter, sans-serif' }}>
                    {link.label}
                  </Link>
                </li>
              ))}
