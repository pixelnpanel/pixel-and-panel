    ...
    return (
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-7">
            ...
            <select
                ...
                className="w-full rounded-xl border border-slate-200 bg-[#FAF8F4] px-4 py-3.5 text-base text-[#1C1917] outline-none transition focus:border-[#0EA5E9] focus:bg-white focus:ring-4 focus:ring-[#0EA5E9]/15"
            >
                {sizes.map((s) => (
            ...
            {sides.length > 1 && !isCustom && (
                <div className="mt-5">
                    ...
                    <div className="inline-flex rounded-xl border border-slate-200 bg-[#FAF8F4] p-1">
                        {sides.map((s) => {
                            const active = s === side
                            return (
                                <button
            ...
            {/* PRICE DISPLAY */}
            <div className="mt-6 rounded-xl border border-slate-100 bg-[#FAF8F4] p-5">
                {showPrice ? (
                    <>
