...
const bestForBySlug = {
  ...
  "table-covers": ["Trade show booths and expos", "Corporate meetings and sponsored events", "Outdoor markets and display tables"],
  "event-tents": ["Outdoor festivals and community events", "Branded event and sponsor setups", "Food service and pop-up retail"],
...
export default function SignageProductPage({ product }) {
  ...
  const cityServiceCities = getAvailableCitiesForService(product.slug);
  ...
  return (
    <>
      ...
      <div className="bg-[#FAF8F4] text-[#1C1917]">
        ...
        {/* ── CITY+SERVICE LINKS ───────────────────────────────── */}
        {cityServiceServices[product.slug] && cityServiceCities.length > 0 && (
