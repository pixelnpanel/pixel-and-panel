...
const sections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "vendorName", label: "Supplier name", placeholder: "Supplier or production partner" },
      { key: "vendorOrderNumber", label: "Supplier order number", placeholder: "Supplier PO / order" },
      { key: "vendorCost", label: "Supplier cost", type: "number", min: "0", step: "0.01" },
