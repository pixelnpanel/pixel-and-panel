...
const staticPages = [
  ...
  { url: "/refund-reprint-policy", priority: 0.3, changeFrequency: "yearly" },
  { url: "/payment-policy", priority: 0.3, changeFrequency: "yearly" },
  { url: "/proof-approval-policy", priority: 0.3, changeFrequency: "yearly" },
  { url: "/website-service-terms", priority: 0.3, changeFrequency: "yearly" },
  { url: "/legal-notice", priority: 0.3, changeFrequency: "yearly" },
  // Service area hubs
