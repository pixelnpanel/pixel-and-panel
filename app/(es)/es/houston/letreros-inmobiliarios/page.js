...
const service = houstonServicesEs["letreros-inmobiliarios"];
const PATH = "/es/houston/letreros-inmobiliarios";
...
export const metadata = withDefaultSocialImage({
  ...
  alternates: {
    ...
    languages: {
      ...
      "x-default": `https://www.pixelnpanel.com${service.enPath}`,
...
export default function HoustonRealEstateSignsRouteEs() {
