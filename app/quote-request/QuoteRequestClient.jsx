...
export default function QuoteRequestClient({ selectedProduct = "", selectedCategory = "" }) {
    ...
    const defaultMessage = hasSelectedProduct ? `I would like a quote for ${selectedProduct}.` : "";
                ...
                <div className="relative mx-auto grid max-w-6xl items-center gap-16 lg:grid-cols-2">
                    ...
                    >
                        ...
                        <motion.p variants={fadeUp} className="mt-8 max-w-lg text-lg leading-8 text-slate-200">
                            Fill in the form and we will get back to you within 1 business day with a custom quote — no pressure, no obligation.
                        </motion.p>
                    ...
                    >
                        ...
                        <p className="mt-2 text-sm text-slate-400">Takes less than 2 minutes to fill out.</p>
                        ...
                        {hasSelectedProduct && (
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-xs font-bold uppercase tracking-widest text-[#1C1917]">Product Selected</p>
                        ...
                        {submitted ? (
                            ...
                            >
                                ...
                                <h3 className="mt-4" style={{ color: "#1C1917" }}>Request Sent</h3>
                                <p className="mt-2 text-sm leading-6 text-slate-600">
                                    We received your quote request and will reply within 1 business day.
                                </p>
                            </motion.div>
                        ) : (
                        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div>
                                <label className="mb-2 block text-xs font-bold uppercase tracking-wide">Email Address *</label>
                            ...
                            <div>
                                <label className="mb-2 block text-xs font-bold uppercase tracking-wide">Phone Number</label>
                            ...
                            <div>
                                <label className="mb-2 block text-xs font-bold uppercase tracking-wide">What Do You Need? *</label>
                                <textarea name="message" required defaultValue={defaultMessage} placeholder="Tell us size, quantity, deadline, material, location, or anything you already know." rows={5} className="w-full resize-none rounded-xl border-2 border-slate-200 bg-white px-4 py-3 text-base outline-none transition focus:border-[#0369A1]" />
                            </div>
                            ...
                            <p className="text-center text-xs text-slate-400">We respond within 1 business day. No spam, ever.</p>
                        </form>
                        )}
                    </motion.div>
