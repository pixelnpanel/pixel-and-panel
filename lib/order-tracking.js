...
export function mapOrder(order, updates = [], files = []) {
  ...
  return {
    ...
    zohoContactId: order.zoho_contact_id || order.zohoContactId || null,
    zohoEstimateId: order.zoho_estimate_id || order.zohoEstimateId || null,
    zohoSalesOrderId: order.zoho_salesorder_id || order.zohoSalesOrderId || null,
    zohoInvoiceId: order.zoho_invoice_id || order.zohoInvoiceId || null,
    zohoDocumentNumber: order.zoho_document_number || order.zohoDocumentNumber || "",
    zohoStatus: order.zoho_status || order.zohoStatus || "Not synced",
    zohoLastSyncAt: order.zoho_last_sync_at || order.zohoLastSyncAt || null,
    status,
