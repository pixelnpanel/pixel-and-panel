    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "For physical signage, print, installation, delivery, permitting, or related production work, Pixel & Panel may use third-party vendors, production partners, installers, or service providers. Pixel & Panel may share only the information reasonably needed to complete the requested work.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Some physical signage, print, installation, delivery, permitting, or production work may be completed by third-party vendors, production partners, installers, or service providers.",
        ],
      },
      {
      ...
      },
      {
        heading: "Delays",
        body: [
          "Project timelines depend on customer response time, file readiness, proof approval, payment, vendor availability, production schedules, shipping, weather, installation conditions, platform access, and other factors.",
          "Pixel & Panel is not responsible for delays caused by customer delays, third-party vendors, shipping carriers, weather, platform outages, permitting offices, or circumstances outside reasonable control.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Materials ordered for a customer project, rush fees, vendor costs, production costs, shipping, delivery, installation, permit, or other third-party costs.",
  ...
  proofApprovalPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Changes requested after approval may cause extra charges, production delays, rush fees, vendor fees, material costs, or reprint costs.",
        ],
      },
    ],
  },
  ...
  legalNotice: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Some signage, print, installation, delivery, permitting, production, or related services may involve third-party vendors, production partners, installers, or service providers.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          "Pixel & Panel aims to respond to business inquiries as soon as reasonably possible during normal business days. Response times may vary based on workload, project schedule, holidays, vendor availability, or customer request type.",
        ],
      },
      {
