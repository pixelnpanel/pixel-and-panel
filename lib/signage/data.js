...
// 6 h: the sheet changes a few times a week, and this ceiling also governs
// the sitemap and both home pages, which inherit it via getCategories().
...
const PRODUCT_ORDER = {
    ...
    'canvas-and-poster-prints': ['poster-print', 'stretched-canvas-print', 'framed-canvas-print'],
    hardware: [
