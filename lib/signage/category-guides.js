...
const GUIDES = {
  ...
  "vinyl-decals-and-window-graphics": {
    intro:
      "Adhesive graphics go almost anywhere — glass, walls, floors, vehicles — but the film has to match the surface. Pick wrong and it lifts at the edges or leaves residue behind.",
    faqs: [
      ["Which film do I need for glass, a wall, or a vehicle?",
        "Flat glass and painted walls take standard calendered vinyl. Curved or riveted panels need high-performance cast film. Vehicle wraps use wrap-grade 3M with an air-release adhesive. Windows you still need to see out of use one-way perforated film."],
      ["Will decals damage paint, glass, or drywall?",
        "Applied and removed correctly, no. Factory-cured paint and glass come away clean, and wall fabric is designed to peel off without residue — which is why it's popular in leased space. Freshly painted surfaces should cure about 30 days first."],
      ["How long do adhesive graphics last outdoors?",
        "Roughly 3–5 years for laminated calendered vinyl and 5–8 for cast film. Constant direct sun shortens both. A laminate also protects against scuffs, washing, and cleaning chemicals."],
    ],
  },
  "dimensional-letters": {
    intro:
      "Channel letters are the signage most people picture on a storefront — individual fabricated letters mounted to the building. The lighting style drives both the look at night and the price.",
    faqs: [
      ["What's the difference between front-lit and halo-lit letters?",
        "Front-lit letters have translucent acrylic faces that glow outward — the most legible choice from the road. Halo-lit (reverse-lit) letters have solid metal faces and throw light back onto the wall for a silhouette effect, which reads as more upscale but less far."],
      ["Do I need a permit for channel letters?",
        "Almost always, and the rules vary by city and sometimes by landlord. Exterior building signage typically needs a permit and an electrical inspection. Tell us your address early and we'll factor the requirements into the layout."],
      ["Is installation included?",
        "Installation is quoted with the sign, since it depends on the fascia, the height, and the power run. Letters mount on a raceway or flush to the wall — we'll recommend which suits your building."],
    ],
  },
  "trade-show-displays": {
    intro:
      "A trade show display is a frame plus a printed graphic, and the frame is what you keep. Buy the right size for your booth and you'll reprint the graphic for years instead of rebuying the whole wall.",
    faqs: [
      ["What size display fits a 10x10 booth?",
        "An 8 ft or 10 ft wall covers the back of a standard 10x10 booth. Go to 20 ft only for a double booth. Add a counter and lights and a 10 ft wall reads as a complete, finished booth."],
      ["Curved or straight?",
        "Straight walls give you the most usable graphic area and butt cleanly against neighboring booths. Curved walls feel softer and more inviting from an angle, at the cost of a little printable width."],
      ["Can I reprint just the fabric later?",
        "Yes, and that's the main reason to buy fabric over rigid panels. The aluminum frame outlasts several graphics, so a rebrand or a new campaign only costs a new print."],
    ],
  },
  "seg-displays": {
    intro:
      "SEG stands for silicone edge graphic — a thin silicone strip sewn into the fabric edge that tucks into a groove in the frame. The result is a seamless, frameless panel with no visible hardware.",
    faqs: [
      ["What makes SEG different from a regular fabric display?",
        "The graphic sits flush inside the extrusion instead of wrapping around it, so there's no visible frame, no hem, and no wrinkling at the edges. It's the cleanest-looking fabric display and the standard for retail and showroom walls."],
      ["Are backlit SEG displays evenly lit?",
        "Yes — edge-lit LED frames spread light across the whole panel rather than hot-spotting behind the middle. Backlit graphics are printed on a dedicated blockout-backed fabric so the illumination reads evenly."],
      ["Can I swap the graphic myself?",
        "Yes. The silicone edge presses into the channel by hand with no tools, so changing a campaign takes minutes and the frame stays on the wall."],
    ],
  },
  "canvas-and-poster-prints": {
    intro:
      "Posters and canvas cover the wall-decor end of large format — same printers, very different finish. Paper is cheap and swappable; canvas is a finished piece you hang once.",
    faqs: [
      ["Poster, stretched canvas, or framed canvas?",
        "Posters are the economical pick for anything you'll rotate — sales, events, showtimes. Stretched canvas wraps around a wooden bar and hangs with no frame for a gallery look. Framed canvas adds a moulding for a finished, higher-end presentation."],
      ["Will the colors fade?",
        "We print with pigment inks that hold up far better than dye. Out of direct sunlight, expect years without noticeable shift. Canvas can be coated for extra UV and scuff protection."],
      ["What resolution do you need from me?",
        "Bigger is better, but we can work with less than you'd think — a poster viewed from several feet away needs far less detail than a print you'll stand next to. Send what you have and we'll tell you honestly how large it will hold up."],
    ],
  },
  hardware: {
    intro:
      "Displays outlive their graphics, and hardware wears or goes missing before the print does. This is the replacement side — stand bases, flag poles, tent weights, lights, and hanging kits to keep what you already own working.",
    faqs: [
      ["Can I reprint a graphic and reuse my old stand?",
        "Usually yes — that's the whole point of buying a stand. Most retractable and tension stands take a fresh printed graphic or cassette, so tell us the model and we'll match the replacement to it."],
      ["Will hardware bought elsewhere fit my display?",
        "Often, but bases, poles, and frames vary between manufacturers. Send us the model name or a photo of the part, and we'll confirm it fits before anything ships."],
      ["Do I need weights or stakes for my flag or tent?",
        "It depends on the surface. Grass takes a ground stake; pavement needs a weighted base or fillable water bag. Never run a flag or tent on a hard surface without weight — wind will move it."],
    ],
  },
};
