...
export const cityServiceServices = {
  'vehicle-graphics': {
    ...
    seo: {
      'beaumont-tx': {
        title: 'Vehicle Graphics Beaumont TX | Truck Lettering & Business Decals',
        description: 'Custom vehicle graphics, truck lettering, magnets, and business decals for Beaumont, TX businesses. Clean design, print-ready artwork, and fast quote support.',
      },
    },
  ...
  'metal-signs': {
    name: 'Metal Signs',
    type: 'signage',
    mainHref: '/signage/metal-signs',
    quoteProduct: 'Metal Signs',
    quoteCategory: 'Signage',
    seo: {
      'beaumont-tx': {
        title: 'Metal Signs Beaumont TX | Durable Business & Outdoor Signs',
        description: 'Durable custom metal signs for Beaumont businesses, offices, shops, job sites, and outdoor use. Get clean design support and a fast quote from Pixel & Panel.',
      },
    },
    ...
    crossSell: { label: 'Storefront Signs', href: '/signage/storefront-signs', description: 'If the metal sign is part of a larger storefront update, review the broader storefront sign options too.' },
  },
  ...
  'vinyl-banners': {
    ...
    seo: {
      'beaumont-tx': {
        ...
        description: 'Order custom vinyl banners for Beaumont TX businesses, events, churches, schools, grand openings, and promotions. Full-color banner design and print support from Pixel & Panel.',
      },
    },
    ...
    relatedLinks: [
      { label: 'Business Cards', href: '/signage/business-cards', description: 'Add professional cards for handoffs, referrals, and event follow-up.' },
    ],
  },
  ...
  'business-cards': {
    ...
    mainHref: '/signage/business-cards',
    ...
    seo: {
      'nederland-tx': {
        ...
        description: 'Need business cards in Nederland TX? Pixel & Panel designs and prints clean, professional business cards for contractors, realtors, salons, restaurants, and local businesses.',
      },
    },
    ...
    crossSell: { label: 'Brochures', href: '/signage/brochures', description: 'Use brochures when customers need more detail than a card can hold.' },
    relatedLinks: [
      { label: 'Vinyl Banners', href: '/signage/vinyl-banners', description: 'Promote openings, events, and seasonal offers with larger-format print.' },
    ],
  },
  ...
  'web-development': {
    ...
    seo: {
      'beaumont-tx': {
        title: 'Web Design Beaumont TX | Pixel & Panel',
        description: 'Pixel & Panel builds clean, mobile-friendly websites for Beaumont TX contractors, restaurants, shops, and local service businesses. Get a website made to turn visitors into calls.',
      },
    },
    headline: (city) => city.slug === 'beaumont-tx'
  ...
  'google-business-profile': {
    ...
    seo: {
      'beaumont-tx': {
        title: 'Google Business Profile Help Beaumont TX | Get Found on Google',
        description: 'Pixel & Panel helps Beaumont businesses improve their Google Business Profile so customers can find them, call them, and request quotes more easily.',
      },
    },
