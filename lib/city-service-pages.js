...
export const cityServiceServices = {
  ...
  'web-development': {
    ...
    seo: {
      'beaumont-tx': {
        title: 'Web Design Beaumont TX | Sites Built to Get Calls',
        description: 'Clean, mobile-first websites for Beaumont contractors, shops, and service businesses — built to turn visitors into calls and quote requests. Free quote.',
      },
    },
    headline: (city) => city.slug === 'beaumont-tx'
  ...
  'google-business-profile': {
    ...
    seo: {
      'beaumont-tx': {
        title: 'Google Business Profile Beaumont TX | Get Found on Maps',
        description: 'Get your Beaumont business found on Google Maps. We fix categories, photos, and listings so more local customers call and request quotes. Free quote.',
      },
    },
