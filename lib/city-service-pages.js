...
export const cityServiceServices = {
  ...
  'web-development': {
    ...
    seo: {
      'beaumont-tx': {
        title: 'Web Design Beaumont TX | Small Business Websites',
        description: 'Web design for Beaumont, TX businesses that need a clear mobile site, local SEO structure, quote forms, and practical Google visibility.',
      },
    },
    headline: (city) => `Web Design in ${city.name}, TX for Local Businesses`,
