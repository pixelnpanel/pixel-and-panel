...
export const digitalServicesEs = [
  {
    ...
    name: "Desarrollo Web",
    title: "Desarrollo Web | Pixel & Panel",
    description:
      "Sitios web rápidos y móviles para negocios del sureste de Texas que necesitan convertir visitantes en llamadas, mensajes y cotizaciones.",
    h1: "Desarrollo web para negocios locales",
    intro:
      "Un buen sitio web debe explicar lo que haces, verse profesional en celular y hacer fácil que un cliente llame, escriba o pida una cotización.",
    helps: [
      "Convertir visitantes en solicitudes de cotización",
      "Explicar tus servicios de forma clara en celular",
      "Conectar tu sitio web con letreros, impresos y códigos QR",
    ],
    includes: [
      "Estructura móvil primero",
      "Páginas claras de servicios y contacto",
      "Flujo de solicitud de cotización",
      "Configuración básica de SEO local",
      "Metadatos listos para Google",
    ],
    bestFor: [
      "Negocios nuevos que necesitan una base profesional",
      "Contratistas y servicios locales que necesitan más solicitudes",
      "Restaurantes, tiendas y negocios que necesitan generar confianza",
    ],
    how:
      "Pixel & Panel crea sitios enfocados en páginas claras, velocidad móvil y rutas de contacto que tienen sentido para clientes locales.",
    faqs: [
      ["¿Necesito un sitio web si ya tengo Perfil de Google?", "Sí. El sitio te da más control sobre tus servicios, páginas, cotizaciones y confianza de marca."],
      ["¿El sitio funciona bien en celular?", "Sí. El diseño móvil es prioridad porque muchos clientes locales buscan y llaman desde el teléfono."],
      ["¿El sitio puede conectarse con códigos QR?", "Sí. Podemos conectar letreros, flyers, tarjetas y menús a páginas útiles del sitio."],
    ],
  ...
  },
  {
    ...
    title: "Automatización CRM | Pixel & Panel",
    description:
      "Automatización CRM simple para organizar solicitudes, formularios y seguimientos de clientes locales.",
    h1: "Automatización CRM para responder más rápido",
    intro:
    ...
    helps: [
      ...
      "Conectar formularios y campañas QR con un proceso más claro",
    ],
    includes: [
      "Planeación de captura de leads",
      "Flujo de solicitud de cotización",
      "Estructura básica de pipeline",
      "Guía para seguimiento por correo",
      "Ruteo de leads desde campañas QR",
    ],
    bestFor: [
    ...
    faqs: [
      ["¿Necesito un CRM complicado?", "No. Muchos negocios locales necesitan algo simple que capture leads y facilite responder."],
      ...
      ["¿Los escaneos QR pueden convertirse en leads?", "Sí. Las campañas QR pueden enviar a páginas o formularios útiles."],
    ],
